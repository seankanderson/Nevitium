...
package businessmanager.InvoiceQuote.LayoutManager;

import businessmanager.Common.PrintPanel;
...
public InvoicePrintPanel(DocumentLayout dl, Invoice inv, int start, int end, double scale) {
        super();
