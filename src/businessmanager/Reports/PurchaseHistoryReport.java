...
import businessmanager.InvoiceQuote.InvoiceItem;
import businessmanager.InvoiceQuote.InvoicePayment;

import datavirtue.DV;
import datavirtue.DbEngine;
import datavirtue.LinePrinter;
...
public PurchaseHistoryReport(GlobalApplicationDaemon application){
...
public void buildReport(){
    ...
    /* Get all of the payments for each day */
        ...
        for (int r = 0; r < temp.getRowCount(); r++){
           ...
           inv = new Invoice(application, (Integer)temp.getValueAt(r, 0));
